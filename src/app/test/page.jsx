...

          {
            selectedSemester === 1 && selectedDepartment === 'Electronics' && (
              <div className="space-y-2">
                ...
                <Link href='/firstsem' ><button className='bg-emerald-400 rounded-lg text-xl px-4 text-black mx-80 ' >explore resources</button></Link>
              </div>
            )
          }
          {
            selectedSemester === 2 && selectedDepartment === 'Electronics' && (
              <div className="space-y-2">
                ...
                <Link href='/secondsem' ><button className='bg-emerald-400 rounded-lg text-xl px-4 text-black mx-80 my-8 ' >explore resources for 2nd sem</button></Link>
              </div>
            )
          }{
